...
import { Calculator, Receipt, CreditCard, FileCheck, ChevronLeft, ChevronRight } from 'lucide-react';
      ...
      <div className="py-8 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="fdrd" id="fdrd">
              <div className="flex flex-col md:flex-row md:gap-6">
                <div className="flex-1 mb-6 md:mb-0">
                  <FdRdCalculator />
                </div>
            ...
            <TabsContent value="ppfepf" id="ppfepf">
              <div className="flex flex-col md:flex-row md:gap-6">
                <div className="flex-1 mb-6 md:mb-0">
                  <PpfEpfCalculator />
                </div>
          ...
          {/* FAQ Section */}
          <div className="mt-16 bg-white rounded-lg shadow-md p-6 border border-gst-light-purple/20">
            <FAQ />
          </div>
          
          <div className="mt-6 text-center text-xs text-gray-500">
            <p className="mb-1">Download your calculations as PDF using the PDF button in the results card.</p>
            <p>Switch between different calculators using the tabs above.</p>
          </div>
          
          <div className="mt-6 text-center text-sm text-gray-500">
            <p>© 2025 Fincalci Pro - Your Financial Calculator Suite</p>
          </div>
        </div>
      </div>
    </div>
